...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { bairro: @funcionario.bairro, cep: @funcionario.cep, cidade: @funcionario.cidade, cpf: @funcionario.cpf, data_nasc: @funcionario.data_nasc, login: @funcionario.login, logradouro: @funcionario.logradouro, nome: @funcionario.nome, num_logradouro: @funcionario.num_logradouro, pais: @funcionario.pais, salario: @funcionario.salario, senha: @funcionario.senha, uf: @funcionario.uf } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { bairro: @funcionario.bairro, cep: @funcionario.cep, cidade: @funcionario.cidade, cpf: @funcionario.cpf, data_nasc: @funcionario.data_nasc, login: @funcionario.login, logradouro: @funcionario.logradouro, nome: @funcionario.nome, num_logradouro: @funcionario.num_logradouro, pais: @funcionario.pais, salario: @funcionario.salario, senha: @funcionario.senha, uf: @funcionario.uf } }
